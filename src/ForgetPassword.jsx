      ...
      <Card className='forget-password'>
        <CardContent>
          ...
          <div className='forget-password-button'>
            <Button variant='contained' sx={{ marginLeft: "auto" }} color='primary' type='submit' >Ok</Button>
            <Button variant='contained' color='error' onClick={()=>navigate('/login')} type="submit" >Cancel</Button>
          </div>
        </CardContent>
      </Card>
    </form>
